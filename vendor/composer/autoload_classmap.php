...
return array(
    'Karriere\\JsonDecoder\\Binding' => $vendorDir . '/karriere/json-decoder/src/Binding.php',
    'Karriere\\JsonDecoder\\Bindings\\AliasBinding' => $vendorDir . '/karriere/json-decoder/src/Bindings/AliasBinding.php',
    'Karriere\\JsonDecoder\\Bindings\\ArrayBinding' => $vendorDir . '/karriere/json-decoder/src/Bindings/ArrayBinding.php',
    'Karriere\\JsonDecoder\\Bindings\\CallbackBinding' => $vendorDir . '/karriere/json-decoder/src/Bindings/CallbackBinding.php',
    'Karriere\\JsonDecoder\\Bindings\\DateTimeBinding' => $vendorDir . '/karriere/json-decoder/src/Bindings/DateTimeBinding.php',
    'Karriere\\JsonDecoder\\Bindings\\FieldBinding' => $vendorDir . '/karriere/json-decoder/src/Bindings/FieldBinding.php',
    'Karriere\\JsonDecoder\\Bindings\\RawBinding' => $vendorDir . '/karriere/json-decoder/src/Bindings/RawBinding.php',
    'Karriere\\JsonDecoder\\ClassBindings' => $vendorDir . '/karriere/json-decoder/src/ClassBindings.php',
    'Karriere\\JsonDecoder\\Exceptions\\InvalidBindingException' => $vendorDir . '/karriere/json-decoder/src/Exceptions/InvalidBindingException.php',
    'Karriere\\JsonDecoder\\Exceptions\\JsonValueException' => $vendorDir . '/karriere/json-decoder/src/Exceptions/JsonValueException.php',
    'Karriere\\JsonDecoder\\JsonDecoder' => $vendorDir . '/karriere/json-decoder/src/JsonDecoder.php',
    'Karriere\\JsonDecoder\\PropertyAccessor' => $vendorDir . '/karriere/json-decoder/src/PropertyAccessor.php',
    'Karriere\\JsonDecoder\\Transformer' => $vendorDir . '/karriere/json-decoder/src/Transformer.php',
